...
* **Author(s):** Name (mail), ...
* **Status:** draft | implemented | rejected | withdrawn | replaced
...
- [System Interface (API)](#system-interface--api-)
...
For every new component on the diagram, explain which use cases does it solve.
